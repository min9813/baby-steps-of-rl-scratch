    ...
    def train_loop(self, env, agent, episode=200, initial_count=-1,
        ...
        for i in range(episode):
            ...
            while not done:
                ...
                env_list = env.step(a)
                if len(env_list) == 4:
                    n_state, reward, done, info = env_list
                else:
                    n_state, reward, done, truncated, info = env.step(a)
...
class Observer():
    ...
    def step(self, action):
        ...
        return self.transform(observation), reward, terminated, info
